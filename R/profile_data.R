...
#public_file_name <- "COVID_Cases_Public_Limited_20210928.csv"
public_file_name <- "COVID_Cases_Public_Limited_20210928.parquet"
...
public_report_title <- "COVID-19 Case Surveillance Public Use Data Profile (2021-09-28 version)"

public_geo_file_name <- "public_county_geography_2021-09-28.parquet"
...
public_geo_report_title <- "COVID-19 Case Surveillance Public Use Data with Geography Profile (2021-09-28 version)"
