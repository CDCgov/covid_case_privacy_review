...
#public_file_name <- "COVID_Cases_Public_Limited_20210621.csv"
public_file_name <- "COVID_Cases_Public_Limited_20210621.parquet"
...
public_report_title <- "COVID-19 Case Surveillance Public Use Data Profile (2021-06-21 version)"

public_geo_file_name <- "public_county_geography_2021-06-21.parquet"
...
public_geo_report_title <- "COVID-19 Case Surveillance Public Use Data with Geography Profile (2021-06-21 version)"
